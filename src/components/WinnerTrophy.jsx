    ...
    <section className="winner-banner" aria-live="polite">
      ...
      <div className="trophy" aria-hidden="true">
        <svg viewBox="0 0 120 140" className="trophy-svg">
          ...
          {/* cup */}
          <path
            d="M30 28 H90 L82 78 Q60 92 38 78 Z"
            fill="url(#trophyGold)"
          />
          <path
            d="M36 32 H78 L72 70 Q60 78 44 70 Z"
            fill="url(#trophyShine)"
          />
          {/* stem + base */}
          <rect x="52" y="88" width="16" height="18" rx="2" fill="url(#trophyGold)" />
          <rect x="38" y="106" width="44" height="10" rx="3" fill="url(#trophyGold)" />
